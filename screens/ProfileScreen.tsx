    ...
    const fetchProfile = async () => {
      try {
        ...
        const res = await fetch(
          `${process.env.EXPO_PUBLIC_API_URL}/userProfile`,
          {
            method: "POST",
    ...
    <>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          />
          <ToggleRow
            label="Miscarriage Support"
            value={miscarriageSupport}
            onValueChange={setMiscarriageSupport}
          />
          <ToggleRow
            label="Premature Birth Info"
            value={prematureInfo}
            onValueChange={setPrematureInfo}
          />
        </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.linkRow}>
            <Text style={[styles.linkText, { color: "#c53030" }]}>
              Delete Account
            </Text>
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={{ marginTop: 12 }}
            >
              <Text style={{ color: "#6b46c1", textAlign: "center" }}>
                Cancel
              </Text>
            </TouchableOpacity>
          </View>
